...
//	$method = $this->removeAnyParameters($method);
	...
	/** 
	    ...
	    However (and see http://sourceforge.net/mailarchive/forum.php?thread_name=4A5D8D34.4010605%40falko-usere.de&forum_name=phpcallgraph-general) there is a bug where the class of the called method is sometimes left unset
