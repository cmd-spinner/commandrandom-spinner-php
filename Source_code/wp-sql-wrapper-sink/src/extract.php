...
class StringExtractor extends PHPParser_NodeVisitorAbstract
{
    ...
    private static function setup()
    {
        if (self::$sqlKeywords===null)
            self::$sqlKeywords=explode(PHP_EOL,file_get_contents(__DIR__."/sqlkeywords.txt"));
        if (self::$sqlSymbols===null)
            self::$sqlSymbols=explode(PHP_EOL,file_get_contents(__DIR__."/sqlsymbols.txt"));
    }
